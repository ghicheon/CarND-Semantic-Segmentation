...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits,train_op, loss = optimize(output_layer,correct_label,learning_rate,2 )
        sess.run(Tf.gloal_bariables_initializer())

        # TODO: Train NN using the train_nn function
        train_nn(sess, EPOCH_CNT, BATCH_CNT, get_batchs_fn,train_op, loss, input_image,correct_label,
